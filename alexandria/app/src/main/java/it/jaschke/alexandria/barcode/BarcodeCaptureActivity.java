...
public final class BarcodeCaptureActivity extends AppCompatActivity {
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        /*
        Capturing barcode : Nice trick by adding a callback
        ...
        BarcodeTrackerFactory barcodeFactory = new BarcodeTrackerFactory(mGraphicOverlay, new BarcodeGraphicTracker.Callback() {
            @Override
            public void onBarcodeFound(String barcodeValue) {
                Debug.e("Barcode : " + barcodeValue, false);
    ...
    public void finish() {
        ...
        if (barcode != null) {
            resultIntent.putExtra(BarcodeObject, barcode);
